          ...
          <div style={{ marginTop: "0rem" }} className="row">
            <div className="col s8 offset-s2">
              <h5>
                ...
                <br /> Veuillez de vous rediriger sur la page oublie de mot de
                passe pour renvoyer le lien
              </h5>
        ...
        <div className="container">
          <div style={{ marginTop: "0rem" }} className="row">
            <div className="col s8 offset-s2">
              ...
              <p className="grey-text text-darken-1">
                Vous n'avez plus besoin de modifier votre mot de passe ?{" "}
              ...
              {updated && (
                <div className="container">
                  <p className="grey-text text-darken-1">
                    ...
                    <Link to="/login">Se connecter nouveau</Link>
                  </p>
                  <br />
                  <p className="grey-text text-darken-1">
                    Vous pouvez sauter direcetement sur la page d'acceuil{" "}
